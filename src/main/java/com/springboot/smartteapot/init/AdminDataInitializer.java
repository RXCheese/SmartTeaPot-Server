package com.springboot.smartteapot.init;

import java.util.HashSet;
import java.util.Set;

import com.springboot.smartteapot.bean.*;
...
//		createResource("资源管理", "resource", "", menu1);
		...
		createResource("设备管理", "pot", "bitbucket", root);
		createResource("设备数据统计", "dataGram", "database", root);
		createResource("味道分享站", "pot", "cloud-upload", root);
